...
const EasyWeightLossConsultationForm = ({
  ...
  return (
    <section className="max-w-7xl mx-auto py-2 p-4 md:my-8">
      <div className="relative bg-white py-4 rounded-3xl shadow-lg border-[#3881c5] border-[1px]">
        {page === "allurion" ? (
          <div>
            <p
            ...
            <div className="flex flex-wrap gap-4 justify-center  md:w-4/6 mx-auto">
              <div>
                ...
                <label
                  className={`${
                    epilogue.className
                  } text-sm p-2 text-textDarkBlue rounded-lg ${
                    selectedOptions.includes("Diabetes/Pre-diabetes")
                      ? "bg-[#c0d4e8]"
                      : "bg-[#EFF8FF]"
                  }`}
              ...
              <div>
                ...
                <label
                  className={`${
                    epilogue.className
                  } text-sm p-2 text-textDarkBlue  p-2 rounded-lg ${
                    selectedOptions.includes("Sleep Apnea")
                      ? "bg-[#c0d4e8]"
                      : "bg-[#EFF8FF]"
                  }`}
              ...
              <div>
                ...
                <label
                  className={`${
                    ...
                    selectedOptions.includes("Fatty Liver")
                      ? "bg-[#c0d4e8]"
                      : "bg-[#EFF8FF]"
                  }`}
              ...
              <div>
                ...
                <label
                  className={`${
                    ...
                    selectedOptions.includes("Thyroid")
                      ? "bg-[#c0d4e8]"
                      : "bg-[#EFF8FF]"
                  }`}
              ...
              <div>
                ...
                <label
                  className={`${
                    ...
                    selectedOptions.includes("High Cholestrol")
                      ? "bg-[#c0d4e8]"
                      : "bg-[#EFF8FF]"
                  }`}
...
export default EasyWeightLossConsultationForm;
